...
6. Add the cleanest address you have when logging a spot; the app geocodes name/address data with OpenStreetMap + Nominatim, stores Latitude/Longitude in Google Sheets, and renders those markers in Explore.
