...
6. Add the cleanest address you have when logging a spot; the app geocodes name/address data, stores Latitude/Longitude in Google Sheets, and renders those markers in Explore.
